...
$_about = "Tentang";
$_action = "Aksi";
$_add_agent_reseller = "Tambah Agent Reseller";
...
$_agent_code = "Kode Agent";
$_agent_contact = "Kontak";
$_agent_reseller = "Agent Reseller";
$_agent_reseller_list = "Daftar Agent Reseller";
$_all = "Semua";
$_address = "Alamat";
...
$_dns_name = "Nama DNS";
$_edit = "Edit";
$_edit_agent_reseller = "Edit Agent Reseller";
...
$_target_voucher_profile = "Target Profil Voucher";
$_upload = "Unggah";
$_upload_logo = "Unggah Logo";
$_upload_config = "Unggah Konfig";
$_uptime = "Hidup";
...
$_vouchers = "Voucher";
$_yes = "Ya";
$_agent_member = "Member Agent Reseller";
$_agent_report = "Report Agent Reseller";
$_agent_locked_used_voucher = "Agent tidak bisa diubah karena voucher/user ini sudah digunakan.";
$_agent_edit_unused_voucher = "Agent bisa diubah selama voucher/user ini belum digunakan.";
$_agent_has_related_vouchers = "Agent Reseller tidak bisa dihapus karena masih terhubung dengan data voucher/user.";
$_agent_code_locked = "Kode Agent tidak bisa diubah karena masih terhubung dengan data voucher/user.";
$_backup_restore_config = "Backup / Restore Konfig";
$_download_backup = "Unduh Backup";
$_config_file = "File Konfig";
$_commission_amount = "Nominal Komisi";
