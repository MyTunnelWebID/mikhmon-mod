...
$_about = "Tungkol";
$_action = "Gawa";
$_add_agent_reseller = "Magdagdag ng Agent Reseller";
$_add = "mag add";
...
$_agent_contact = "Contact";
$_agent_reseller = "Agent Reseller";
$_agent_reseller_list = "Listahan ng Agent Reseller";
$_all = "Lahat";
$_address = "Address";
...
$_edit = "Edit";
$_edit_agent_reseller = "I-edit ang Agent Reseller";
...
$_start = "Simula";
$_select_profile = "Pumili ng Profile";
...
$_traffic = "Trapik";
$_target_voucher_profile = "Target Voucher Profile";
$_upload = "Upload";
$_upload_logo = "Upload Logo";
$_upload_config = "Upload Config";
$_uptime = "Uptime";
$_uptime_user = "Uptime";
...
$_yes = "Oo";
$_agent_member = "Mga Member ng Agent Reseller";
$_agent_report = "Ulat ng Agent Reseller";
$_agent_locked_used_voucher = "Hindi na puwedeng palitan ang agent dahil nagamit na ang voucher/user na ito.";
$_agent_edit_unused_voucher = "Puwede pang palitan ang agent habang hindi pa nagagamit ang voucher/user na ito.";
$_agent_has_related_vouchers = "Hindi puwedeng alisin ang Agent Reseller dahil may kaugnay pa itong data ng voucher/user.";
$_agent_code_locked = "Hindi puwedeng palitan ang Agent code dahil may kaugnay pa itong data ng voucher/user.";
$_backup_restore_config = "Backup / Restore Config";
$_download_backup = "Download Backup";
$_config_file = "Config File";
$_commission_amount = "Halaga ng Commission";
