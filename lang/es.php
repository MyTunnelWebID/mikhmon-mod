...
$_about = "Acerca";
$_action = "Acción";
$_add_agent_reseller = "Agregar Agente Revendedor";
...
$_agent_code = "Código de Agente";
$_agent_contact = "Contacto";
$_agent_reseller = "Agente Revendedor";
$_agent_reseller_list = "Lista de Agentes Revendedores";
$_all = "Todo";
$_address = "Dirección";
...
$_edit = "Editar";
$_edit_agent_reseller = "Editar Agente Revendedor";
...
$_start = "Inicio";
$_select_profile = "Seleccionar Perfil";
...
$_traffic = "Trafico";
$_target_voucher_profile = "Perfil de Voucher Objetivo";
$_upload = "Cargar";
$_upload_logo = "Cargar Logo";
$_upload_config = "Cargar Config";
$_uptime = "Actividad";
...
$_vouchers = "Vouchers";
$_yes = "Si";
$_agent_member = "Miembros de Agente Revendedor";
$_agent_report = "Reporte de Agente Revendedor";
$_agent_locked_used_voucher = "El agente no se puede cambiar porque este voucher/usuario ya fue usado.";
$_agent_edit_unused_voucher = "El agente se puede cambiar mientras este voucher/usuario no haya sido usado.";
$_agent_has_related_vouchers = "El Agente Revendedor no se puede eliminar porque todavía está vinculado a datos de voucher/usuario.";
$_agent_code_locked = "El código del agente no se puede cambiar porque todavía está vinculado a datos de voucher/usuario.";
$_backup_restore_config = "Backup / Restaurar Config";
$_download_backup = "Descargar Backup";
$_config_file = "Archivo Config";
$_commission_amount = "Monto de Comisión";
