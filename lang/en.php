...
$_about = "About";
$_action = "Action";
$_add_agent_reseller = "Add Agent Reseller";
$_add = "Add";
...
$_agent_reseller_list = "Agent Reseller List";
$_all = "All";
$_address = "Address";
...
$_start = "Start";
$_select_profile = "Select Profile";
...
$_vouchers = "Vouchers";
$_yes = "Yes";
$_agent_member = "Agent Reseller Members";
$_agent_report = "Agent Reseller Report";
$_agent_locked_used_voucher = "Agent cannot be changed because this voucher/user has already been used.";
$_agent_edit_unused_voucher = "Agent can still be changed while this voucher/user has not been used yet.";
$_agent_has_related_vouchers = "Agent Reseller cannot be deleted because it is still linked to voucher/user data.";
$_agent_code_locked = "Agent code cannot be changed because it is still linked to voucher/user data.";
$_backup_restore_config = "Backup / Restore Config";
$_download_backup = "Download Backup";
$_config_file = "Config File";
$_commission_amount = "Commission Amount";
