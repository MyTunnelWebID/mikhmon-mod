...
if (!isset($_SESSION["mikhmon"])) {
    ...
    /* Version ChangeLog */
        $_SESSION["copyright-mod"] = "2023 - " . date("Y") ." MyTunnel Team";
        $_SESSION["author-mod"] = "MyTunnel Team";
        $_SESSION["licence-mod"] = "MIT License";
    ...
    /* Version ChangeLog */
        ...
        $_SESSION["vm-old"] = "1.10 20-05-2025";
        $_SESSION["vm"] = "2.00 06-04-2026";
    /* Version ChangeLog */
    }
